...
const QUEUE_LABEL = {
    ...
    700: 'Clash', 720: 'Clash ARAM', 890: 'Bot', 900: 'ARURF', 1020: 'One for All',
    1300: 'Nexus Blitz', 1400: 'Ultimate Spellbook', 1700: 'Arena', 1710: 'Arena (16j)',
    1820: 'Swarm', 1900: 'Pick URF', 2300: 'Brawl', 2400: 'ARAM: Mayhem', 0: 'Custom'
};
...
const QUEUE_MODE = {
    ...
    700: 'ranked', 720: 'aram', 890: 'other', 900: 'other', 1020: 'other',
    1300: 'other', 1400: 'other', 1700: 'other', 1710: 'other',
    1820: 'other', 1900: 'other', 2300: 'other', 2400: 'aram',
};
// Human-readable label for each mode bucket (used by tabs + companions header)
const MODE_LABELS = { all: 'All', ranked: 'Ranked', normal: 'Normal', aram: 'ARAM', other: 'Other' };

// Season boundaries — date-based because match-v5 doesn't include seasonId.
// IDs/names reference: https://static.developer.riotgames.com/docs/lol/seasons.json
const SEASONS = [
    { id: 'S2026', label: 'S2026', from: new Date('2026-01-08').getTime(), to: null },
    { id: 'S2025', label: 'S2025', from: new Date('2025-01-10').getTime(), to: new Date('2026-01-07T23:59:59').getTime() },
    { id: 'S2024', label: 'S2024', from: new Date('2024-01-10').getTime(), to: new Date('2025-01-09T23:59:59').getTime() },
];
